        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-10 px-5 lg:grid-cols-2 lg:gap-16 lg:px-10">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-col gap-3 border-t border-white/10 pt-6 sm:flex-row">
              ...
              <a
                href={telHref()}
                className="flex h-12 items-center justify-center rounded-input border border-white/30 px-6 text-sm font-semibold text-white hover:border-brass-lit hover:text-brass-lit"
